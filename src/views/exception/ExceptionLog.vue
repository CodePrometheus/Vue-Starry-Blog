  ...
  methods: {
    listLogs() {
      this.axios.get('/api/admin/exception/logs', {
        ...
        this.logs = data.data.recordList
...
<template>
  <el-card class='main-card'>
    ...
    <el-table
      @selection-change='selectionChange' v-loading='loading' :data='logs'>
      <el-table-column type='selection' width='55' align='center' />
      <el-table-column prop='optUri' label='请求接口' align='center' width='250' />
      <el-table-column prop='optDesc' label='操作描述' align='center' width='150' />
      <el-table-column prop='requetMethod' label='请求方式' align='center' width='140'>
    ...
    <!--  详细信息  -->
    <el-dialog
      :visible.sync='isCheck' append-to-body top='20px' width='80%' destroy-on-close
    >
