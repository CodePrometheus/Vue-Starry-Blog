  ...
  methods: {
    ...
    listJobs() {
      ...
      this.axios.get('/api/admin/jobs', {
        ...
        this.jobs = data.data.recordList
    ...
    handleRun(job) {
      this.axios.put('/api/admin/jobs/run', {
        param: {
          id: job.id,
...
<template>
  <el-card class='main-card'>
    ...
    <el-form ref='queryForm' :inline='true' label-width='68px' style='margin-top: 25px'>
          ...
          <template slot-scope='scope'>
            ...
            <el-dropdown size='mini' @command='(command) => handleCommand(command, scope.row)'>
              ...
              <el-dropdown-menu slot='dropdown'>
                ...
                <el-dropdown-item command='handleView' icon='el-icon-view'>任务详情</el-dropdown-item>
    ...
    <el-dialog :title='title' :visible.sync='dialogFormVisible' width='800px' append-to-body>
      <el-form ref='dataForm' :model='job' :rules='rules' lable-width='120px'>
        <el-row>
          <el-col :span='12'>
            <el-form-item label='任务名称' prop='jobName'>
